  ...
  Widget controllerBuilder(BuildContext context, UserController controller) {
    return Scaffold(
      body: Stack(
        children: [
          Image.asset(
            Utils.getImgPath('bg_launch', dir: 'bg'),
            width: double.infinity,
            height: double.infinity,
            fit: BoxFit.cover,
          ),
          if (controller.isInited && controller.user == null) _buildLoginBtn()
        ],
      ),
    );
  }
            ...
            child: Row(
              ...
              children: [
                CommonBtn(
                  ...
                  text: Ids.login.str(),
                  textStyle: TextStyle(color: Colours.white, fontSize: 28.sp),
                  backgroundColor: Colours.c_00CE3E,
                  borderRadius: 12.w,
                  height: 80.w,
                  width: 200.w,
                ),
                CommonBtn(
                  ...
                  text: Ids.register.str(),
                  textStyle:
                      TextStyle(color: Colours.c_00CE3E, fontSize: 28.sp),
