...
import 'package:wechat/widget/red_dot_widget.dart';
...
class _MainBottomBarState extends State<MainBottomBar> {
    ...
    return Container(
      ...
      child: Row(
          children: [
            ...
            _buildTabItem('tabbar_discover_normal','tabbar_discover_selected',Ids.discover.str(),2,showDot: true),
  ...
  Widget _buildTabItem(String icon , String iconSelected , String title , int index,{bool? showDot}){
