...
/// See also:
///
///  * [PanelListView], which is a commonly used [ScrollView] that displays a
...
abstract class ScrollView extends StatelessWidget {
  ...
  ///
  /// Also when true, the scroll view is used for default []s. If a
  ...
  /// example [PanelListView] will use the number of widgets in the child list,
  ...
  Widget build(BuildContext context) {
    ...
    final PanelScrollable scrollable = PanelScrollable(
    ...
    // scrollable.createState().setIgnorePointer(value)
...
/// [PanelListView] or [CustomScrollView], the top item and all of the items below it
...
/// this information automatically. For example, [PanelListView] provides each child
...
/// See also:
///
///  * [PanelListView], which is a [BoxScrollView] that uses a linear layout model.
...
///
/// [PanelListView] is the most commonly used scrolling widget. It displays its
/// children one after another in the scroll direction. In the cross axis, the
/// children are required to fill the [PanelListView].
///
...
/// [controller] with its [ScrollController.initialScrollOffset] property set.
///
/// By default, [PanelListView] will automatically pad the list's scrollable
/// extremities to avoid partial obstructions indicated by [MediaQuery]'s
/// padding. To avoid this behavior, override with a zero [padding] property.
///
/// {@tool snippet}
/// This example uses the default constructor for [PanelListView] which takes an
/// explicit [List<Widget>] of children. This [PanelListView]'s children are made up
...
///
/// A [PanelListView] is basically a [CustomScrollView] with a single [SliverList] in
/// its [CustomScrollView.slivers] property.
///
/// If [PanelListView] is no longer sufficient, for example because the scroll view
...
/// [PanelListView] to using [CustomScrollView] directly.
///
/// The [key], [scrollDirection], [reverse], [controller], [primary], [physics],
/// and [shrinkWrap] properties on [PanelListView] map directly to the identically
...
///
/// The [childrenDelegate] property on [PanelListView] corresponds to the
/// [SliverList.delegate] (or [SliverFixedExtentList.delegate]) property. The
/// [PanelListView] constructor's `children` argument corresponds to the
...
/// like [PanelListView]s do. To reproduce the behavior, wrap the slivers in
/// [SliverSafeArea]s.
///
...
/// {@tool snippet}
///
/// Here are two brief snippets showing a [PanelListView] and its equivalent using
/// [CustomScrollView]:
///
/// ```dart
/// ListView(
...
/// [PanelListView] at build time with whatever widgets you need to show for the
/// empty list state:
///
/// {@tool snippet}
///
...
///
/// {@tool dartpad}
/// This example shows a custom implementation of [ListTile] selection in a [PanelListView] or [GridView].
...
class PanelListView extends BoxScrollView {
  ...
  ///
  /// Providing a non-null `itemCount` improves the ability of the [PanelListView] to
  ...
  /// created in advance, or all at once when the [PanelListView] itself is created,
  /// it is more efficient to use the [PanelListView] constructor. Even more
  ...
  /// view's children are created in advance, or all at once when the [PanelListView]
  /// itself is created, it is more efficient to use the [PanelListView] constructor.
  ///
  /// {@macro flutter.widgets.PageView.findChildIndexCallback}
  ///
  /// {@tool snippet}
  ///
  /// This example shows how to create [PanelListView] whose [ListTile] list items
  ...
  /// {@tool snippet}
  ///
  /// This [PanelListView] uses a custom [SliverChildBuilderDelegate] to support child
  /// reordering.
  ///
  /// ```dart
  ...
  /// A delegate that provides the children for the [PanelListView].
  ///
  /// The [ListView.custom] constructor lets you specify this delegate
  /// explicitly. The [PanelListView] and [ListView.builder] constructors create a
...
///
/// To create a linear array of children, use a [PanelListView].
///
/// To control the initial scroll offset of the scroll view, provide a
/// [controller] with its [ScrollController.initialScrollOffset] property set.
///
...
///
/// {@tool dartpad}
/// This example shows a custom implementation of [ListTile] selection in a [GridView] or [PanelListView].
/// Long press any ListTile to enable selection mode.
///
/// ** See code in examples/api/lib/widgets/scroll_view/listview_select.1.dart **
/// {@end-tool}
...
///  * [SingleChildScrollView], which is a scrollable widget that has a single
///    child.
///  * [PanelListView], which is scrollable, linear list of widgets.
///  * [PageView], which is a scrolling list of child widgets that are each the
///    size of the viewport.
///  * [CustomScrollView], which is a scrollable widget that creates custom
///    scroll effects using slivers.
