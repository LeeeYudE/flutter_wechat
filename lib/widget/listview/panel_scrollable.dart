...
/// Signature used by [PanelScrollable] to build the viewport through which the
/// scrollable content is displayed.
typedef ViewportBuilder = Widget Function(BuildContext context, ViewportOffset position);

/// A widget that scrolls.
///
/// [PanelScrollable] implements the interaction model for a scrollable widget,
/// including gesture recognition, but does not have an opinion about how the
/// viewport, which actually displays the children, is constructed.
///
/// It's rare to construct a [PanelScrollable] directly. Instead, consider [ListView]
/// or [GridView], which combine scrolling, viewporting, and a layout model. To
/// combine layout models (or to use a custom layout mode), consider using
/// [CustomScrollView].
///
/// The static [PanelScrollable.of] and [PanelScrollable.ensureVisible] functions are
/// often used to interact with the [PanelScrollable] widget inside a [ListView] or
/// a [GridView].
///
...
class PanelScrollable extends StatefulWidget {
  ...
  /// [ScrollAction].
  ///
  /// If not supplied, the [PanelScrollable] will scroll a default amount when a
  ...
  /// Whether the scroll actions introduced by this [PanelScrollable] are exposed
  ...
  @override
  PanelScrollableState createState() => PanelScrollableState();
  ...
  /// ```
  ///
  /// Calling this method will create a dependency on the closest [PanelScrollable]
  /// in the [context], if there is one.
  static PanelScrollableState? of(BuildContext context) {
  ...
  ///
  /// The heuristic used is determined by the [physics] of this [PanelScrollable]
  ...
  ///
  /// If there is no [PanelScrollable] in the widget tree above the [context], this
  ...
  static Future<void> ensureVisible(
    ...
    PanelScrollableState? scrollable = PanelScrollable.of(context);
    while (scrollable != null) {
      ...
      scrollable = PanelScrollable.of(context);
    }
...
class _ScrollableScope extends InheritedWidget {
  ...
  final PanelScrollableState scrollable;
...
/// State object for a [PanelScrollable] widget.
///
/// To manipulate a [PanelScrollable] widget's scroll position, use the object
/// obtained from the [position] property.
///
/// To be informed of when a [PanelScrollable] widget is scrolling, use a
/// [NotificationListener] to listen for [ScrollNotification] notifications.
///
/// This class is not intended to be subclassed. To specialize the behavior of a
/// [PanelScrollable], provide it with a [ScrollPhysics].
///
...
class PanelScrollableState extends State<PanelScrollable> with TickerProviderStateMixin, RestorationMixin
    implements ScrollContext {
  /// The manager for this [PanelScrollable] widget's viewport position.
  ///
  /// To control what kind of [ScrollPosition] is created for a [PanelScrollable],
  ...
  bool _shouldUpdatePosition(PanelScrollable oldWidget) {
  ...
  @override
  void didUpdateWidget(PanelScrollable oldWidget) {
...
///
/// This function is used as the type for [PanelScrollable.incrementCalculator],
...
/// [ScrollAction] on a [PanelScrollable].
///
/// This is used to configure a [ScrollIncrementDetails] object to pass to a
/// [ScrollIncrementCalculator] function on a [PanelScrollable].
///
...
/// [PanelScrollable.incrementCalculator], or by its defaults if that is not
/// specified.
...
/// An [Action] that scrolls the [PanelScrollable] that encloses the current
...
/// [ScrollAction]s.
///
/// If [PanelScrollable.incrementCalculator] is null for the scrollable, the default
...
class ScrollAction extends Action<ScrollIntent> {
  ...
  bool isEnabled(ScrollIntent intent) {
    ...
    if (contextIsValid) {
      ...
      if (PanelScrollable.of(focus.context!) != null)
        return true;
      ...
      if (PrimaryScrollController.of(focus.context!) != null) {
        ...
        return primaryScrollController != null
            ...
            && PanelScrollable.of(primaryScrollController.position.context.notificationContext!) != null;
      }
    }
    return false;
  }
  ...
  double _calculateScrollIncrement(PanelScrollableState state, { ScrollIncrementType type = ScrollIncrementType.line }) {
    assert(type != null);
  ...
  double _getIncrement(PanelScrollableState state, ScrollIntent intent) {
  ...
  void invoke(ScrollIntent intent) {
    PanelScrollableState? state = PanelScrollable.of(primaryFocus!.context!);
    if (state == null) {
      final ScrollController? primaryScrollController = PrimaryScrollController.of(primaryFocus!.context!);
      state = PanelScrollable.of(primaryScrollController!.position.context.notificationContext!);
    }
