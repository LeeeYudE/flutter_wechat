            ...
            children: [
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  _buildBottomBar(backgroundColor??const Color.fromRGBO(41, 41, 41, 0.7), iconColor??const Color.fromARGB(255, 200, 200, 200), barHeight),
                ],
              ),
            ],
          ),
  ...
  Widget _buildHitArea() {
    ...
    return GestureDetector(
      ...
      child: CenterPlayButton(
        backgroundColor: widget.backgroundColor??const Color.fromRGBO(41, 41, 41, 0.7),
        iconColor: widget.iconColor??const Color.fromARGB(255, 200, 200, 200),
